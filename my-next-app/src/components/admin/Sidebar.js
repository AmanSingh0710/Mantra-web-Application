            ...
            <aside className={`
                ...
                <nav className="p-2 space-y-1">
                    ...
                    <div>
                        ...
                        {openSubMenu === 'reports' && (
                            <div className="ml-9 mt-1 space-y-1 border-l border-gray-700">
                                <SidebarSubItem label="Earning Reports" tab="earning_report" activeTab={activeTab}/>

                                <SidebarSubItem label="Inhouse Sales" tab="inhouse_sales" activeTab={activeTab}/>

                                <SidebarSubItem label="Vendor Sales" tab="vendor_sales" activeTab={activeTab}/>

                                <SidebarSubItem label="Transaction Report" tab="transaction_report" activeTab={activeTab}/>
                            </div>
                        )}
                    </div>
                    ...
                    <button
                        onClick={() => {
                            setActiveTab("product_report");
                            setIsOpen(false);
                        }}
                        className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-md hover:bg-[#ffffff10] transition ${activeTab === "product_report"
                            ? "bg-amber-600 text-white"
                            : "text-gray-300"
                            }`}
                    >
                    ...
                    <button
                        onClick={() => {
                            setActiveTab("order_report");
                            setIsOpen(false);
                        }}
                        className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-md hover:bg-[#ffffff10] transition ${activeTab === "order_report"
                            ? "bg-amber-600 text-white"
                            : "text-gray-300"
                            }`}
                    >
                        <FaChartLine size={16} className="text-gray-400" />
                        <span className="text-sm font-medium">Order Report</span>
                    </button>
