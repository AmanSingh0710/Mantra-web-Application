...
export default function StoryPage() {
  ...
  if (loading) {
    return (
      <div className="w-full bg-[#f1f3f6] min-h-screen py-4">
  ...
  return (
    // min-h-screen aur bg-[#f1f3f6] add kiya hai jo Flipkart/Amazon ka standard page background hai, isse black space hat jayega
    <main className="w-full min-h-screen bg-[#f1f3f6] select-none">
      <section className="w-full bg-white py-6 sm:py-8 border-b border-gray-200 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          
          {/* SECTION TRADEMARK TITLE */}
          <div className="flex items-center justify-between mb-4 px-1">
            <h2 className="text-sm sm:text-base font-extrabold text-gray-950 tracking-wide">
              TRENDING STORIES & OFFERS
            </h2>
            <span className="text-xs text-blue-600 font-bold hover:underline cursor-pointer flex items-center gap-0.5 whitespace-nowrap">
            ...
            {stories.map((story) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Typography Labels Block mirroring your screenshot style */}
                  <h3 className="text-sm font-bold text-gray-900 mt-3 px-1 truncate w-full group-hover:text-blue-600 transition-colors">
                    {story.title}
                  </h3>
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mt-1 hover:text-gray-600">
                    Read More
                  </span>
                </div>
              );
        ...
        {activeStory && (
          <div className="fixed inset-0 bg-black/95 sm:bg-black/80 z-[100] flex items-center justify-center p-0 sm:p-4 backdrop-blur-md">
            ...
            {/* Card Engine Frame */}
            <div className="relative w-full h-[100dvh] sm:h-auto sm:max-h-[85vh] sm:w-[400px] sm:aspect-[9/16] bg-black sm:rounded-2xl overflow-hidden shadow-2xl border border-white/5 flex flex-col justify-between p-4 text-white">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-transparent to-black/75 pointer-events-none z-10" />
              ...
              <div className="relative z-20 bg-black/60 p-4 rounded-xl border border-white/10 backdrop-blur-md space-y-2 mb-4">
                <div>
